...
class ColorChannel():
    ...
    async def fetch_color_capabilities(self, from_cache):
        ...
        attributes = ["color_temp_physical_min","color_temp_physical_max","color_capabilities",]
        ...
        if capabilities is None:
            ...
            result = await self.get_attribute_value("color_temperature", from_cache=from_cache)
