...
class EmberIncomingMessageType():
...
class EmberOutgoingMessageType():
...
class EmberInitialSecurityBitmask():
...
class EmberCurrentSecurityBitmask():
...
class EzspSourceRouteOverheadInformation():
