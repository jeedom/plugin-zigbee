...
WSTK_XON_XOFF = False
WSTK_RTS_CTS = True
# Silicon Labs TBS2(J-Link Pro OB)
TBS2_VID= '1366'
TBS2_PID = '1015'
TBS2_BAUD = 115200
TBS2_XON_XOFF = True
...
def ezspV8Init(ser):
	...
	ser.write(b'\x80\x70\x78\x7E') #ack
...
def scan():
    ...
    for port in serial.tools.list_ports.comports():
        ...
        try:
            ...
            if (vid == CEL_VID and pid == CEL_PID) or (vid == WSTK_VID and pid == WSTK_PID) or (vid == TBS2_VID and pid == TBS2_PID):
                ...
                if vid == WSTK_VID and pid == WSTK_PID:
                    ...
                    RTS_CTS = WSTK_RTS_CTS
                # Check if TBS2 board
                if vid == TBS2_VID and pid == TBS2_PID:
                    BAUD = TBS2_BAUD
                    XON_XOFF = TBS2_XON_XOFF
                    RTS_CTS = TBS2_RTS_CTS
