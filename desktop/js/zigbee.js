...
function addCmdToTable(_cmd) {
  ...
  tr += '<span><label class="checkbox-inline"><input type="checkbox" class="cmdAttr" data-l1key="configuration" data-l2key="ignoreExecutionError"/>{{Ignorer les erreurs d\'éxecution}}</label></span> ';
  tr += '</td>';
  tr += '<td>';
